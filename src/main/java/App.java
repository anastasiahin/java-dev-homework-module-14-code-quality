...
public class App {
    public static void main(String[] args) {
        App game = new App(); // Створення об'єкта класу
        game.runGame();       // Запуск основного методу гри
    }
    ...
    private byte getUserMove(Scanner scan, char[] board) {
        byte move;
        while (true) {
            move = scan.nextByte();
    ...
    private byte getComputerMove(char[] board) {
        byte move;
        while (true) {
